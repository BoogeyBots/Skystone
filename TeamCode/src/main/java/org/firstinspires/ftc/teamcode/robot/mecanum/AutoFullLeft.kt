...
class AutoFullLeft : BBLinearOpMode() {
	...
	override fun runOpMode() {
		...
		// GO TO TRAY
		get<Mecanum>().sideways(36.0, power = 0.8, timeout = 3.0)
		get<Mecanum>().forward(-30.0, power = 0.8, timeout = 3.0)
		get<Hook>().grab()
		sleep(1000)
		get<Mecanum>().forward(35.0, power = 0.5, timeout = 3.0)
		get<Hook>().ungrab()
		sleep(1000)
		// FINISHED WITH TRAY
		// MOVE FROM BEHIND THE TRAY
		get<Mecanum>().sideways(-36.0, power = 0.8, timeout = 3.0)
		get<Mecanum>().forward(-26.0, power = 0.8, timeout = 3.0)
