...
public class DriveConstants {
    ...
    public static final PIDCoefficients MOTOR_VELO_PID = new PIDCoefficients(14.0, 0.0 , 14.0);
     ...
     */
    public static double WHEEL_RADIUS = 1.968;
    public static double GEAR_RATIO = 27.4/8 ; // output (wheel) speed / input (motor) speed
     ...
     * empirically tuned.
     */
    public static double kV = 0.02310;
    public static double kA = 0.0011;
    public static double kStatic = 0.0556;
