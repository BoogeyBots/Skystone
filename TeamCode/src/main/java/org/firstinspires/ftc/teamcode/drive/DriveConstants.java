...
public class DriveConstants {
    ...
    public static final PIDCoefficients MOTOR_VELO_PID = new PIDCoefficients(17.0, 0.0 , 12.0);
     ...
     */
    public static double WHEEL_RADIUS = 2.0; //1.968
    public static double GEAR_RATIO = 28.3/8 ; // 27.4/8 output (wheel) speed / input (motor) speed
    public static double TRACK_WIDTH = 13.5; //16.0
