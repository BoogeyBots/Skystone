...
class SkystoneDetectorExample : LinearOpMode() {
	...
	override fun runOpMode() {
		...
		while (opModeIsActive()) {
             ...
             */
			telemetry.addData("Stone Position X", skyStoneDetector!!.screenPosition.x)
			telemetry.addData("Stone Position Y", skyStoneDetector!!.screenPosition.y)
			telemetry.addData("Frame Count", phoneCam!!.frameCount)
			telemetry.addData("FPS", String.format(Locale.US, "%.2f", phoneCam!!.fps))
